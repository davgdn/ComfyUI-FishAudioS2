...
INT4 PATCH (groxaxo/fish-speech-int4-patch) integrated:
  - Pre-quantized NF4 checkpoint support via 's2-pro-bnb-nf4-prequant' model option
  - _convert_linear_layers_to_bnb4 / _load_prequantized_bnb4_state_dict in llama.py
  - tools/export_nf4.py to export a pre-quantized checkpoint from s2-pro weights
  See CHANGELOG.md for full details.
"""

__version__ = "0.5.4-int4"
